...
const double Constants::ROBOT_POS_LIMIT = 0.18;
const double Constants::SQUARE_WAVE_AMPLITUDE_PKPK_MPS = 0.0; //test
const double Constants::SQUARE_WAVE_FREQUENCY_HZ = 1;
...
const control_type_t Constants::CONTROL_TYPE = CONTROLLER;

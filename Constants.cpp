...
const uint32_t Constants::MONITORING_INTERVAL_MICROSECONDS = 10000;
...
const double Constants::SQUARE_WAVE_AMPLITUDE_PKPK_MPS = 0.1;
const double Constants::SQUARE_WAVE_FREQUENCY_HZ = 4;
